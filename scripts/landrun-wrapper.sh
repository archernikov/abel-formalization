...
# Preserve the outer command delimiter required by Landrun. The pinned
# Comparator supplies it; older Comparator releases omitted it. Accept either
# input shape and emit exactly one outer delimiter, preserving exporter args.
