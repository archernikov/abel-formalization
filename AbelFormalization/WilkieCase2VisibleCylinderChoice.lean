...
/-!
# Wilkie Corollary 2.9, Case 2: visible-cylinder good-slice choice
...
The first theorem proves the exact regular, attained, bounded slice.  The
...
membership stated explicitly.  No extra assumption or placeholder proof is used.
-/
