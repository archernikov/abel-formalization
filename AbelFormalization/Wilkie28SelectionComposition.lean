...
/-!
# Wilkie 2.8 witness-selection composition
...
This module does not assert weak selection or smoothness,
and no new assumption or placeholder proof is introduced. The hypotheses of the final theorem are
