...
/-!
# Source-only recursive Case 2 assembly
...
minor is nonzero at a point of that fiber.  Its final fork is staged below.
...
The only source premises are WS5 exceptional-set membership and smooth
singular-witness selection at every recursively encountered coordinate map.
-/
