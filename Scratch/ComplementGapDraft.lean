...
This unimported source-only draft isolates one handoff in the positive-projection
...
the manuscript's main theorem. No compiler command was run for this draft.
-/
...
maintained WS5 radial-level theorem applies without a definability axiom. -/
